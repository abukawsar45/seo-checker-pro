...
function App() {
    ...
    const handleSearchBox = (e) => {
      ...
      console.log(searchURL);
       ...
       axios({
         ...
         auth: {
           username: 'mostofadev45@gmail.com',
           password: 'dcf02bd52aac6ef2',
           //  username: 'kawsarone45@gmail.com',
           //  password: '15ecffb78f816d41',
         },
         data: post_array,
         headers: {
    ...
    const { duplicate_title, duplicate_description,duplicate_content,cache_control,checks, meta } =
...
const HeaderList=({ data })=> {
  ...
  return (
    ...
    <div>
      <div>
      {showSearchBox && <div className='my-8'>
          ...
          <div>
            ...
            <div className='my-3 md:my-8 lg:my-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-4 lg:gap-5 text-center'>
              ...
              <div className='bg-slate-100 p-2 rounded-md'>
                ...
                <div>
                  <h4 className='pb-2 font-semibold'>Duplicate Description</h4>
                  <p>
                    {duplicate_description
              ...
              {page_timing && (
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-4 lg:gap-5 text-center'>
                  ...
                  <div className='bg-slate-100 p-2 rounded-md'>
                    ...
                    <h4 className='pb-2 font-semibold'>Time to Interactive</h4>
                  </div>
                  <div className='bg-slate-100 p-2 rounded-md'>
                    <h3 className='pt-3 font-medium text-lg'>
